...
#my package
import sys
sys.path.append("/home/suke/hibikino_toms_ws/module/deeplabv3")
...
class Seg_Module():  
    def __init__(self):
        #segmentation tools 
        self.model = Deeplabv3.load_from_checkpoint("/home/suke/hibikino_toms_ws/module/deeplabv3/weights/DeepLabV3_resnet10110-0.26.ckpt",num_class=4)
